                                ...
                                for(int f = 0; f < cordm.length; f++){
                                    for(int c = 0; c < 2; c++){
                                        if(c !=1 && difi <8){
                                            ...
                                            cordnull(f,c);
                                            while(filaesp > 1 || filaesp < 0 || cordm[f][c] >= 5 || cordm[f][c] <=0 || cordesp[filaesp][cordm[f][c]] == true){
                                                ...
                                                filaespnull(f, c);
                                                System.out.print("Usar un valor entre 1 - 4 para la columna del Fantasma " + (difi + 1) + " del jugador 1: " );
                                                cordnull(f,c);
                                            }
                                            cordesp[filaesp][cordm[f][c]] = true;
                                        }else if(c !=1 && difi >= 8){
                                            System.out.print("Insertar la fila para el Fantasma " + (difi - 7) + " del jugador 2: ");
                                            cordnull(f,c);;
                                            filaesp = cordm[f][c];
                                        }else{
                                            System.out.print("Insertar la columna para el Fantasma " + (difi - 7) + " del jugador 2: ");
                                            cordnull(f,c);
                                            while(filaesp > 5 || filaesp < 4 || cordm[f][c] >= 5 || cordm[f][c] <=0 || cordesp[filaesp][cordm[f][c]] == true){
                                                System.out.print("Usar un valor ya sea 5 o 4 para la fila del Fantasma " + (difi - 7) + " del jugador 2. Tener en cuenta los espacios que ya se utilizaron: ");
                                                filaespnull(f, c);
                                                System.out.print("Usar un valor entre 1 - 4 para la columna del Fantasma " + (difi - 7) + " del jugador 2: " );
                                                cordnull(f,c);
                                            }
                                            cordesp[filaesp][cordm[f][c]] = true;
                                        }
